...
pub mod code_analysis {
    use super::*;
    use syn::{File, Item, ItemEnum, ItemFn, ItemImpl, ItemStruct};
    ...
    impl CodeAnalyzer {
        ...
        fn detect_bevy_features(code: &str) -> Vec<String> {
            ...
            let feature_patterns = [
                (
                    "2D Rendering",
                    vec!["Camera2dBundle", "Sprite", "SpriteBundle"],
                ),
                ...
                (
                    "Lighting",
                    vec!["DirectionalLight", "PointLight", "SpotLight"],
                ),
            ];
...
pub mod config_utils {
    ...
    pub fn get_recommended_dependencies(game_type: &str) -> Vec<String> {
        match game_type.to_lowercase().as_str() {
            "platformer" | "2d" => vec!["bevy".to_string()],
            "fps" | "3d" | "shooter" => vec!["bevy".to_string(), "bevy_rapier3d".to_string()],
            "physics" => vec![
                "bevy".to_string(),
                "bevy_rapier2d".to_string(),
                "bevy_rapier3d".to_string(),
            ],
            "ui" | "menu" => vec!["bevy".to_string(), "bevy_egui".to_string()],
            _ => vec!["bevy".to_string()],
        }
    }
}
